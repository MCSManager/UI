            ...
            <el-col :span="24" :offset="0">
              <FunctionGroup :container="true">
                ...
                <FunctionGroup align="right">
                  ...
                  <FunctionComponent>
                    <el-button size="small" v-if="!isRoot" @click="move">
...
export default defineComponent({
      ...
      menus: [
        ...
        },
        {
          ...
          click: () => {
            if (this.isRoot) {
              this.$message({
                message: window.$t('fileManager.isRoot'),
                type: "error"
              });
              return;
            }
  ...
  computed: {
    ...
    isRoot() {
      // return this.currentDirArray[this.currentDirArray.length-1].value === '/' && !this.isWindows
      return this.statusInfo.isGlobalInstance && this.currentDirArray.slice(-1)[0].value === "/" && !this.isWindows;
    }
  },
  async mounted() {
    if (this.paramPath) {
