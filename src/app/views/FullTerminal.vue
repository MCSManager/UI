...
<template>
  <div>
    <div class="full-terminal-wrapper">
      <div id="full-terminal-container" style="height: 560px; width: 100%"></div>
      <div id="full-terminal-input-wrapper">
        <el-input
...
export default {
  ...
  methods: {
    ...
    initTerm() {
      // 创建窗口与输入事件传递
      this.term = initTerminalWindow(document.getElementById("full-terminal-container"));
...
#full-terminal-input-wrapper input {
  width: 100%;
  font-size: 12px;
}
</style>
