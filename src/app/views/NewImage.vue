...
RUN apt update
WORKDIR /workspace
RUN apt -y update && apt install libcurl4-openssl-dev -y && apt install wget -y && wget http://security.ubuntu.com/ubuntu/pool/main/o/openssl/libssl1.1_1.1.1l-1ubuntu1.6_amd64.deb && dpkg -i libssl1.1_1.1.1l-1ubuntu1.6_amd64.deb
`;
